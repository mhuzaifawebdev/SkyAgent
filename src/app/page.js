            ...
            >
              {isLoading ? (
                ...
                <>
                  ...
                  <span className="group-hover:text-gray-200 transition-colors">Continue with Google</span>
                </>
              )}
            </button>
    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <style jsx>{`
        ...
        .animated-border::before {
          ...
          inset: 0;
          padding: 2px;
          background: linear-gradient(45deg, #4a5568, #2d3748, #1a202c, #2d3748, #4a5568);
        ...
        .animated-border:hover::before {
          background: linear-gradient(45deg, #718096, #4a5568, #2d3748, #4a5568, #718096);
          background-size: 300% 300%;
      ...
      <div className="relative z-10 p-6">
        ...
        <nav className="animated-border p-4 mb-12 transition-all duration-300">
          <div className="flex items-center justify-between relative z-10">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-white text-xl font-semibold">Skyline-Agent</span>
            </div>
            ...
            >
              <span className="group-hover:text-gray-200 transition-colors">Get Started</span>
            </button>
          </div>
        </nav>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold text-white mb-6">Your AI-Powered Task Assistant</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <div className="animated-border p-6 group transition-all duration-300">
              <div className="relative z-10">
                ...
                <h3 className="text-white text-xl font-semibold mb-3">Secure Google Authentication</h3>
                <p className="text-gray-400 text-sm leading-relaxed">Seamless sign-in with your Google account. Your data stays protected with enterprise-grade security.</p>
              </div>
            </div>
            ...
            <div className="animated-border p-6 group transition-all duration-300">
              <div className="relative z-10">
                ...
                <h3 className="text-white text-xl font-semibold mb-3">Smart Task Management</h3>
                <p className="text-gray-400 text-sm leading-relaxed">Create, organize, and track your tasks with an intuitive interface. Never miss a deadline again.</p>
              </div>
            </div>
            ...
            <div className="animated-border p-6 group transition-all duration-300">
              <div className="relative z-10">
                ...
                <h3 className="text-white text-xl font-semibold mb-3">Google Calendar Sync</h3>
                <p className="text-gray-400 text-sm leading-relaxed">Automatically sync your tasks to Google Calendar. Keep all your events and deadlines in one place.</p>
              </div>
            </div>
            ...
            <div className="animated-border-glow p-6 group lg:col-span-2 transition-all duration-300">
              <div className="relative z-10">
                ...
                <h3 className="text-white text-xl font-semibold mb-3">Intelligent AI Assistant</h3>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 bg-gray-700/30 text-gray-300 text-xs rounded-lg">Voice Commands</span>
                  <span className="px-3 py-1 bg-gray-700/30 text-gray-300 text-xs rounded-lg">Smart Scheduling</span>
                  <span className="px-3 py-1 bg-gray-700/30 text-gray-300 text-xs rounded-lg">Context Aware</span>
                </div>
              </div>
            </div>
            ...
            <div className="animated-border p-6 group transition-all duration-300">
              <div className="relative z-10">
                ...
                <h3 className="text-white text-xl font-semibold mb-3">Smart Email Reminders</h3>
                <p className="text-gray-400 text-sm leading-relaxed">Get timely email notifications for your tasks and appointments. Stay on top of your schedule effortlessly.</p>
              </div>
            </div>
          </div>
            ...
            <div className="animated-border p-12 max-w-4xl mx-auto transition-all duration-300">
              <div className="relative z-10">
                ...
                <p className="text-gray-400 mb-8 text-lg max-w-2xl mx-auto">
                  Join the future of task management with Skyline-Agent. Automate your workflow, sync with Google services, and let AI handle the complexity.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  >
                    <span className="group-hover:text-gray-200 transition-colors">Start Free Trial</span>
                  </button>
